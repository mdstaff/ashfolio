defmodule AshfolioWeb.Integration.AccountManagementFlowTest do
  ...
  describe "Complete Account Management Workflow" do
    test "end-to-end account lifecycle: create → validate → list → edit → delete", %{conn: conn, user: user} do
      ...
      |> render_submit(%{
        "form" => %{
          ...
          "platform" => "",  # Invalid: non-numeric balance
    ...
    test "error handling during account operations", %{conn: conn} do
      ...
      edge_case_data = %{
        ...
        "balance" => "999999999999999.99"  # Very large balance
      }
      ...
      assert has_element?(view, "form") # Form still exists
    end
  end
end